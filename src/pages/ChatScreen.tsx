...
import { View, Text, TextInput, FlatList, StyleSheet, TouchableOpacity, KeyboardAvoidingView, Platform, SafeAreaView } from 'react-native';
...
export default function ChatScreen() {
  ...
  const sendMessage = async () => {
    ...
    try {
      await connection.invoke("SendMessage", parseInt(conversationId), user?.userId, text);
      setText('');
    } catch (e) { console.error(e); }
  };
...
const styles = StyleSheet.create({
  ...
  inputContainer: { flexDirection: 'row', padding: 12, backgroundColor: '#FFF', borderTopWidth: 1, borderColor: '#E2E8F0', alignItems: 'center' },
  input: { flex: 1, backgroundColor: '#F1F5F9', borderRadius: 20, paddingHorizontal: 16, paddingVertical: 10, marginRight: 10 },
