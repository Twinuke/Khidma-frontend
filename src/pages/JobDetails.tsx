...
export default function JobDetails() {
  ...
  // ✅ FIX: Removed "Only freelancers can place a bid" check entirely.
  // We only check "user.userId !== job.client.userId" to prevent self-bidding.
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.footer}>
        {/* If User is NOT Owner, show Chat and Bid buttons */}
        {!isOwner ? (
          <View style={{flexDirection: 'row', gap: 10}}>
            ...
            {/* Apply Button (Check if bid placed) */}
            {!hasPlacedBid ? (
