...
export default function JobDetails() {
  ...
  const isOwner = !!user && user.userId === job.client?.userId;
  const isClient = user?.userType === 1;
  const isFreelancer = user?.userType === 2;
      ...
      <View style={styles.footer}>
        {isOwner ? (
          <View>
            ...
            <TouchableOpacity
              style={[styles.bidBtn, { marginTop: 12 }]}
              onPress={() =>
          ...
          <View style={{ flexDirection: "row", gap: 10 }}>
            ...
            {isFreelancer ? (
              ...
              <View style={[styles.bidBtn, styles.bidBtnDisabled, { flex: 2 }]}>
                <Text style={[styles.bidBtnText, styles.bidBtnTextDisabled]}>
                  Only freelancers place bids
                </Text>
              </View>
            )}
          </View>
