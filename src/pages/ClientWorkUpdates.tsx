      ...
      <View style={styles.updateHeader}>
          ...
          {item.freelancer?.profileImageUrl ? (
            <View style={styles.avatar}>
              <Text style={styles.avatarText}>
                {item.freelancer.fullName.charAt(0).toUpperCase()}
              </Text>
            </View>
          ) : (
            <View style={styles.avatar}>
        ...
        <View
          style={[
            ...
            { backgroundColor: getUpdateTypeColor(item.updateType) + "20" },
          ]}
        >
          <Text
            style={[
              styles.updateTypeText,
              { color: getUpdateTypeColor(item.updateType) },
            ]}
          >
            {item.updateType}
          </Text>
            ...
            ListEmptyComponent={
              <View style={styles.emptyState}>
                ...
                <Text style={styles.emptySubtext}>
                  Updates from your freelancer will appear here
                </Text>
              </View>
            }
          />
          ...
          <View style={styles.modalOverlay}>
            <View style={styles.modalContent}>
              <View style={styles.modalHeader}>
                <Text style={styles.modalTitle}>Respond to Update</Text>
                <TouchableOpacity
                ...
                <>
                  <View style={styles.modalUpdatePreview}>
                    <Text style={styles.modalUpdateTitle}>
                      {selectedUpdate.title || selectedUpdate.updateType}
                    </Text>
                    <Text style={styles.modalUpdateContent}>
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={styles.emptyState}>
              ...
              <Text style={styles.emptySubtext}>
                Create a job to start receiving updates
              </Text>
            </View>
          }
        />
